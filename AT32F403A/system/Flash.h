...
#define EXIST_ADDR 0x0801C800

#define FLASH_ADDR0 0x0801D000
#define FLASH_ADDR1 0x0801D800
#define FLASH_ADDR2 0x0801E000
#define FLASH_ADDR3 0x0801E800
#define FLASH_ADDR4 0x0801F000
#define FLASH_ADDR5 0x0801F800
#define FLASH_ADDR6 0x08020000
#define FLASH_ADDR7 0x08020800
#define FLASH_ADDR8 0x08021000
#define FLASH_ADDR9 0x08021800
